                    ...
                    <td>  
                    	<div class="btn-group">
	                        ...
	                        <ul class="dropdown-menu" role="menu">
	                            <li>
	                                <a onclick="return confirm('Are you sure to Edit Fact Category?');" href="{{ route('admin.facts.edit',['id' => $row->id]) }}">
	                                    <i class="icon-docs"></i> Edit </a>
	                            </li>
	                            <li>
	                                <a onclick="return confirm('Are you sure to Delete Fact?');" href="{{ route('admin.facts.delete',['id' => $row->id]) }}">
