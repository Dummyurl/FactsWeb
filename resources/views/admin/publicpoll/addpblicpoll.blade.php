...
@section('content')
	<div class="portlet light portlet-fit portlet-form bordered">
        ...
        <style type="text/css">
            ...
            <!-- BEGIN FORM-->
            <form action="{{ route('admin.publicpoll.store')}}" method="POST" id="form_sample_1" class="form-horizontal" enctype="multipart/form-data">
            @csrf
                <div class="form-body">
                    <div class="form-group">
                        <div class="col-md-3">
                            ...
                            <input type="text" name="title" data-required="1" class="form-control" placeholder="Enter Question" value="{{ !empty($data['row']->title)?$data['row']['title']:'' }}"> 
                            @if($errors->has('title'))
                        ...
                        <div class="col-md-3">
                            ...
                            <input name="public_date" data-provide="datepicker" class="form-control date-picker" type="text" value="{{ !empty($data['row']->description)?$data['row']->description:'' }}">
                        </div>
                        <div class="col-md-3">
                            ...
                            <div class="mt-checkbox-inline mt-radio-list" data-error-container="#form_2_membership_error">
                                <label class="mt-radio">
                                    <input type="radio" name="membership" value="1"> Yes
                                    <span></span>
                                </label>
                                <label class="mt-radio">
                                    <input type="radio" name="membership" value="2"> No
                                    <span></span>
                                </label>
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" name="description" class="form-control" placeholder="Enter Please Enter Otption " value="{{ !empty($data['row']->description)?$data['row']->description:'' }}"> 
                        </div>
                        <div class="col-md-3">
                    ...
                    <div class="form-group" style="display: none">
                        ...
                        <div class="col-md-3">
                            <br> <i class="fa fa-plus fa-2x AddMore"></i>&nbsp;
                            <label class="control-label">Click Plus Option To Add Another option</label>
                        </div>
                    </div>
                </div>
