<head>
        <meta charset="utf-8" />
        <title>Facts Nepal | Admin Dashboard</title>
        ...
        <link href="{{ asset('admin-panel/assets/plugins/bootstrap-daterangepicker/daterangepicker.min.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('admin-panel/assets/plugins/morris/morris.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('admin-panel/assets/plugins/fullcalendar/fullcalendar.min.css') }}" rel="stylesheet" type="text/css" />
       <!--  <link href="{{ asset('admin-panel/assets/plugins/jqvmap/jqvmap/jqvmap.css') }}" rel="stylesheet" type="text/css" /> -->
