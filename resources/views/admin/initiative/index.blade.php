...
<div class="portlet light bordered">
    <div class="portlet-title">
        <div class="caption font-dark">
          <a href="{{ route('admin.initiatives.add') }}">
                    ...
                    <td>  
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li>
                                    <a onclick="return confirm('Are you sure to Edit Fact Category?');" href="{{ route('admin.initiatives.edit',['id' => $row->id]) }}">
                                        <i class="icon-docs"></i> Edit </a>
                                </li>
                                <li>
                                    <a onclick="return confirm('Are you sure to Delete Fact?');" href="{{ route('admin.initiatives.delete',['id' => $row->id]) }}">
