        ...
        return (
                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 pr80">
                                <Fade bottom duration={1100} distance={"150px"}>
                                    <h2 className="white"> Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod </h2>
                                    <p className="white textbanner" > Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit ame </p>
                                </Fade>
                                <Fade bottom duration={1100} distance={"150px"} delay={300}>
                                    <button className="btn btn-primary btn-lg heroleft__btn mr-3" data-id="first" ref="btns"  onClick={e => this.scroll(this.first)}> <span className="fom "> Qualitative Research</span></button>
            ...
            <section className="section-padding-y">
                <div className="container">
                        ...
                        <div className="research-list" >
                            <Fade bottom duration={1200} distance={"100px"}>
                                <div className="research-list__item">
                                    <h4> Student Perceptions of Leadership, Accountability, and Governance of Student Leaders and Unions, 2012 [for Search for Common Ground;</h4>
                                    <p className="nomargin owner">  project funded by FCO/DFID]</p>
                                </div>
                            </Fade>
                            <Fade bottom duration={1200} distance={"100px"} delay={500}>
                                <div className="research-list__item">
                                    <h4>Formative research to "Explore the nature of VAWG, and its effects among migrant labour communities in Baglung district, Nepal"</h4>
                                    <p className="nomargin owner">for VSO Nepal and South African Medical Research Council (SAMRC), 2016</p>
                                </div>
                            </Fade>
                    ...
                    <div className="imgtagholder section-padding-y" id="second" ref={this.second} >
