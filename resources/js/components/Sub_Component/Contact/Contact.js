...
class Contact extends Component {
    ...
    render() { 
            ...
            <div>
                    <h4> Contact Us</h4>
                        ...
                        <div className="btn-holder-contact d-flex justify-content-end mt-2f">
                            <button className="btn btn-primary btn-lg heroleft__btn "> <span className="fom"> Submit</span></button>
                        </div>
                    </div>
        ...
        (
                ...
                {/* <h4> Contact Us</h4> */}
                <p><strong>
                        Do you have a project that FACTS can help you with? To help us understand your needs and better estimate the duration and budget required,
                        answering the following questions will expedite the process.
                    </strong>
                 </p>
                    <div className="row">
                        <div className="col-md-6">
                        ...
                        <div className="col-md-6">
                            <div className="form-group">
                                <label htmlFor="objectives">What are the Objectives of the Project?Is there a problem that you are looking to tackle?</label>
                                <input type="text" className="form-control" id="objectives" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                                <label htmlFor="background">Do you want to provide a brief background of the project?</label>
                                <input type="text" className="form-control" id="background" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                                <label htmlFor="deliverables">What type of deliverables are you expecting?</label>
                                <input type="text" className="form-control" id="deliverables" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                                <label htmlFor="deadlines">Do you have a specific time period or deadlines for the project?</label>
                                <input type="text" className="form-control" id="deadlines" />
                            </div>
                        </div>
                        <div className="col-md-6">
                            <div className="form-group">
                                <label htmlFor="budget">What is your estimated budget for this project?</label>
        ...
        const carrer_form = 
            (
                    <div>
                        <p>
                            <strong>
                                Are you interested in working with us? Please fill up the following form and send your CV along at info@factsnepal.com
                            </strong>
                        </p>
                        <div className="row">
                            <div className="col-md-6">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    ...
                                    <input type="text" className="form-control" id="residential_address" />
                                </div>
                            </div>
                            <div className="col-md-6">
                                <div className="form-group">
                            ...
                            <div className="col-md-6">
                                <div className="form-group">
                                    <label htmlFor="strength">What Strength of yours,do you think can contribute to FACTS?</label>
                    ...
                    <div className="container-fluid">
                        <div className="custom-container">
                            <div className="map-holder__inner">
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d14131.428516947946!2d85.3429673!3d27.6908103!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x857b4d5307df8061!2sFacts+Research+and+Analytics!5e0!3m2!1sen!2snp!4v1555475561046!5m2!1sen!2snp" width="600" height="450" frameBorder="0" style={{ border: 0 }} ></iframe>
                            </div>
                        </div>
                    </div>
                                ...
                                <div className="col-md-8 form-holder">
                                    <div className="contact-form__right">
                                        <div className="form-group">
                                            ...
                                            <select className="form-control" id="sel1" onChange={this.Enquiry_HandleChange}>
...

                                        {
                                            ...
                                            this.state.enquiry_selectValue === 'General' ? general_form
                                            : this.state.enquiry_selectValue === 'Business' ? business_form
                                            : carrer_form
                                ...
                                <div className="col-md-4 rbg">
                                    <div className="contact-form__left">
                                        ...
                                        <div className="contact-form__socialshare relative textcontact">
                                            ...
                                            <i className="la la-twitter-square"></i>
